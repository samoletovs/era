    ...
    <div>
      ...
      <div className="settings-card">
        ...
        <CollapsibleSection title="Currency settings">
          ...
          >
            ECB reference rates are imported automatically at ~16:00 CET daily —
            rates released today apply to next business day (per Latvian
            Accounting Law §5). Custom sources allow manual rate entry and are
            shared across your companies.
          </p>
          <div className="settings-grid">
            <div className="settings-field">
          ...
          >
            ECB rates are imported automatically when the system needs them.
            View and manage exchange rates on the Accounting page.
          </p>
        </CollapsibleSection>
