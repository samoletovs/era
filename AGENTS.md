...
| 5 | ~~Default branch~~ | `main` | `main` (migrated 2026-05) | Migrated from `master` to align with the lab-wide convention. The legacy `master` ref has been deleted from the remote. |
